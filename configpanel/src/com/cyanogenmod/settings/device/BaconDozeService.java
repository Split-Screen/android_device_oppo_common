...
public class BaconDozeService extends Service {
    private static final String TAG = "BaconDozeService";
    ...
    private BaconProximitySensor mSensor;
    private PowerManager mPowerManager;

    private boolean mHandwaveGestureEnabled = true;
    private long mLastDisplayOff;

    class BaconProximitySensor implements SensorEventListener {
        private SensorManager mSensorManager;
        private Sensor mSensor;

        public BaconProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "BaconDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new BaconProximitySensor(mContext);
